...
<img src="https://upload.wikimedia.org/wikipedia/commons/4/46/Diffie-Hellman_Key_Exchange.svg" alt="Diffie-Hellman" height="400" width="300" align="center">
...
<li>Alice chooses her secret number <code><b>a</b></code> and sends Bob the number <code><b>A</b> = g<sup>a</sup> mod p</code>.</p></li>
...
<pre>
1. Alice and Bob choose prime p=23 and base g=5.
2. Alice chooses a=4, and sends Bob value "A"
	A = (5<sup>4</sup> % 23) = 4
3. Bob chooses b=3, and sends Alice value "B"
	B = (5<sup>3</sup> % 23) = 10
4. Alice computes "s"
	s = (10<sup>4</sup> % 23) = 18
5. Bob computes "s"
	s = (4<sup>3</sup> % 23) = 18
6. Both Alice and Bob share the same secret key now. 
</pre>
