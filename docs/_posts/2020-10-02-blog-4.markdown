...
date:   2020-10-02 19:17:31 -0700
categories: Senior-Design
---   

<style>
html{ background-color: #e6e6ff; }
body { background-color: white; }                                                                        pre code {
    color: #666666;
...
<p>User management is one of the most importnat roles that a system administrator fulfills. With my experience from working in the IT department at CSUN, we commonly handle a variety of tasks which pertain to this. Primarily - creating new accounts (portal, canvas, and email) for new students, changing passwords, deleting users, and many other configurations per student. In a file style, there are sets of permissions organized into 3 classes: user, group, and others.

In today's blog, I will be discussing the different ways to manage users.</p>
